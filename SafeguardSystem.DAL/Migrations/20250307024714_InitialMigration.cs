...
namespace SafeguardSystem.DAL.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "ActivationToken", "ActivationTokenExpiry", "Avatar", "BirthDay", "Email", "FullName", "IsActive", "IsDeleted", "IsEmailConfirmed", "IsLocked", "Phone", "ResetToken", "ResetTokenExpiry", "RoleID", "UserName" },
                values: new object[,]
                {
                    { "58sErANL7bbv096ghTnNN3qIiqX2", null, null, "https://www.freepik.com/free-vector/simple-vibing-cat-square-meme_58459053.htm#fromView=keyword&page=1&position=0&uuid=f4bd18ef-8de6-4b6e-8e68-06073abf526b&query=Animal+Memes", new DateTime(2004, 3, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@test.com", "Viet Anh", true, false, true, false, "0123456789", null, null, new Guid("7a04e1d4-c176-467d-ac7d-6e1433ce6f3e"), "Admin" },
                    { "CkjtbJVJQxVm1eLjHW3p10TdV193", null, null, "https://www.freepik.com/free-vector/simple-vibing-cat-square-meme_58459053.htm#fromView=keyword&page=1&position=0&uuid=f4bd18ef-8de6-4b6e-8e68-06073abf526b&query=Animal+Memes", new DateTime(2001, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "guard3@test.com", "Nguyen Hieu", true, false, true, false, "0123456789", null, null, new Guid("d1616b66-90cc-479f-b45e-1e86378937f7"), "Security Guard 3" },
                    { "fH8JsAPWjJOHLvLSI4MJVG4aSBr1", null, null, "https://www.freepik.com/free-vector/simple-vibing-cat-square-meme_58459053.htm#fromView=keyword&page=1&position=0&uuid=f4bd18ef-8de6-4b6e-8e68-06073abf526b&query=Animal+Memes", new DateTime(2001, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "guard2@test.com", "Nguyen Huy", true, false, true, false, "0123456789", null, null, new Guid("d1616b66-90cc-479f-b45e-1e86378937f7"), "Security Guard 2" },
                    { "fNBgIDvy0JTd3wd9enqVywR8o612", null, null, "https://www.freepik.com/free-vector/simple-vibing-cat-square-meme_58459053.htm#fromView=keyword&page=1&position=0&uuid=f4bd18ef-8de6-4b6e-8e68-06073abf526b&query=Animal+Memes", new DateTime(2001, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "guard5@test.com", "Nguyen Dang", true, false, true, false, "0123456789", null, null, new Guid("d1616b66-90cc-479f-b45e-1e86378937f7"), "Security Guard 5" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("7c54454f-337d-4b5b-a2d0-74ad4088686b"), new DateTime(2026, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8857), "Nơi sinh hoạt văn hóa, giải trí dành cho sinh viên", true, false, "Nhà văn hóa sinh viên", "IuyPY3ie8OQG60w0gasxQNkXHzS2" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("399c04bc-31f2-4296-bf32-4b6d3b0cb1c1"), "123456789", 10.882934m, 106.785746m, new DateTime(2025, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8804), "PENDING", "fH8JsAPWjJOHLvLSI4MJVG4aSBr1" },
                    { new Guid("3de02800-eecb-4abe-adb4-cd114896e0bc"), "123456789", 10.882934m, 106.785746m, new DateTime(2025, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8810), "PENDING", "fNBgIDvy0JTd3wd9enqVywR8o612" },
                    { new Guid("5144d02b-8aa2-43d1-88e9-774087acb37e"), "123456789", 10.882934m, 106.785746m, new DateTime(2025, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8808), "PENDING", "GLgL2MXjY7Pg4gmEJrgFulyEgV23" },
                    { new Guid("d2a9201b-59ad-40b7-bde5-dfda937d7433"), "123456789", 10.882934m, 106.785746m, new DateTime(2025, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8797), "PENDING", "ksyosShXa2QizFvCVkpe6dAG3ax1" },
                    { new Guid("e24aa81d-c60e-4dfd-9909-991c837e6631"), "123456789", 10.882934m, 106.785746m, new DateTime(2025, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8806), "PENDING", "CkjtbJVJQxVm1eLjHW3p10TdV193" }
                });

            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "LocationId", "Address", "BusinessId", "CreatedAt", "Image", "IsDeleted", "Latitude", "Longitude", "Name", "PlaceId", "UpdatedAt" },
                values: new object[] { new Guid("c86114da-36c8-4644-8ab0-dbdcb5c2f830"), "Khu phố 6, Phường Linh Trung, Thủ Đức, Thành phố Hồ Chí Minh", new Guid("7c54454f-337d-4b5b-a2d0-74ad4088686b"), new DateTime(2025, 3, 7, 2, 47, 10, 641, DateTimeKind.Utc).AddTicks(8905), "https://www.freepik.com/free-vector/simple-vibing-cat-square-meme_58459053.htm#fromView=keyword&page=1&position=0&uuid=f4bd18ef-8de6-4b6e-8e68-06073abf526b&query=Animal+Memes", false, 10.882934m, 106.785746m, "Nhà văn hóa sinh viên", new Guid("1e4082e7-6e29-4dd4-9976-62bdf598ac43"), null });
